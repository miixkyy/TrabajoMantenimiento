...
class PublicacionesController
{
  ...
  function agregar(){
    if(isset($_POST['agregar']))
    {
      ...
      $resultado = $this->publiModel->agregarPublicacion($titular, $fecha, $cuerpo, $ruta1, $ruta2, $ruta3, $userId, $dep);     
  ...
  function actualizar($id){
    if(isset($_POST['actualizar']))
    {
      ...
      echo"$ruta3";
      echo"$numImagenes";
      $resultado = $this->publiModel->actualizarPublicacion($id,$titular, $cuerpo, $ruta1, $ruta2, $ruta3, $dep, $numImagenes);     
