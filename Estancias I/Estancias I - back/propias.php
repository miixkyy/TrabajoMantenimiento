...
<head>
    ...
    <!-- Agrega este código en la sección <head> de tu página -->
...
<div class="nav" id="lateral">
    ...
    <div class="departamentos">
        ...
        <li><i class="far fa-user"></i></i> Mis publicaciones</li>
...
<?php if (empty($resultado)) : ?>
    <div style="text-align: center;">
            <p style="font-size: 20px; font-weight: bold;"><?php echo $mensaje; ?></p>
            <a href="<?php echo $botonURL; ?>" class="boton"><?php echo $botonTexto; ?></a>
        </div>
    <?php endif; ?>
